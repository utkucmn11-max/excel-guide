...
# --- GELİŞMİŞ CSS (Bozmadan Korundu + Dil Seçici Alanı) ---
st.markdown("""
    <style>
    ...
    /* Sol Üst Dil Seçici İçin Özel Alan */
    .lang-selector {
        position: absolute;
        top: 0;
        left: 0;
...
# --- DİL SEÇİMİ (Sol Üst Köşe) ---
col_lang, col_empty = st.columns([1, 4])
with col_lang:
    # Sidebar olmadan doğrudan sayfa üzerinde
    lang = st.selectbox("", ["Türkçe", "English"], label_visibility="collapsed")
    t = texts[lang]
